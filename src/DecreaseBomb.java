...
//a type of powerUp which decreases your bombs count
public class DecreaseBomb extends PowerUp implements Serializable {
    ...
    public void doAction(GameHandler gameHandler) {
        if(gameHandler.getGameMemory().getPowerUpParameters().getPossibleBombCount()>=2) {
            ...
            System.out.println("Your Bombs Count Decreased -");
        }
    }
}
