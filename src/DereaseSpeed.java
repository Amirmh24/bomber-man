...
//a type of powerUp which decreases your speed
public class DereaseSpeed extends PowerUp implements Serializable {
    ...
    public void doAction(GameHandler gameHandler) {
        if (gameHandler.getGameMemory().getPowerUpParameters().getBombermanSpeed()>=3) {
            ...
            System.out.println("Your Speed Decreased -");
        }
    }
}
