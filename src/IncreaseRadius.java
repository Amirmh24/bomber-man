...
//a type of powerUp which increases your bombs radius
public class IncreaseRadius extends PowerUp implements Serializable {
    ...
    public void doAction(GameHandler gameHandler) {
        if (gameHandler.getGameMemory().getPowerUpParameters().getBombRadius()<=2) {
            ...
            System.out.println("Your Bombs Radius Increased +");
        }
    }
}
