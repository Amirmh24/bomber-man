...
//a type of powerUp which decreases your score 100points;
public class DecreaseScore extends PowerUp implements Serializable {
    ...
    public void doAction(GameHandler gameHandler) {
        ...
        System.out.println("Your Score Decreased -");
    }
}
